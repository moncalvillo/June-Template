...
public class AnonymousShoutListTest extends AcmePlannerTest{
	...
	@Order(10)
	public void listPositive(final int recordIndex, final String author, final String text, final String info,
		final String moment, final String domemi) {
		...
		super.checkColumnHasValue(recordIndex, 4, domemi);
 ...
 */
	...
	public void listNegative(final String username, final String password) {
		...
		super.driver.get("http://localhost:8080/June-Template/anonymous/shout/list");
