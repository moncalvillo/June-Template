...
public class AcmePlannerTest extends AcmeTest{
	...
	public void beforeAll() {
		...
		super.setBaseCamp("http", "localhost", "8080", "/June-Template", "/master/welcome", "?language=en&debug=true");
	...
	protected void checkDashBoard(
		...
		locatorPublicTasks = By.xpath("/html/body/div[2]/div/table[2]/tbody/tr/td[2]");
		locatorprivateTasks = By.xpath("/html/body/div[2]/div/table[2]/tbody/tr/td[3]");
		locatorfinishedTasks = By.xpath("/html/body/div[2]/div/table[2]/tbody/tr/td[4]");
		locatornonFinishedTasks = By.xpath("/html/body/div[2]/div/table[2]/tbody/tr/td[5]");
		
		locatoraverageWorkFlow = By.xpath("/html/body/div[2]/div/table[3]/tbody/tr/td[2]");
		locatordeviationWorkFlow = By.xpath("/html/body/div[2]/div/table[3]/tbody/tr/td[3]");
		locatormaxWorkFlow = By.xpath("/html/body/div[2]/div/table[3]/tbody/tr/td[4]");
		locatorminWorkFlow = By.xpath("/html/body/div[2]/div/table[3]/tbody/tr/td[5]");
		
		locatoraverageExecutionPeriod = By.xpath("/html/body/div[2]/div/table[4]/tbody/tr/td[2]");
		locatordeviationExecutionPeriod = By.xpath("/html/body/div[2]/div/table[4]/tbody/tr/td[3]");
		locatormaxExecutionPeriod = By.xpath("/html/body/div[2]/div/table[4]/tbody/tr/td[4]");
		locatorminExecutionPeriod = By.xpath("/html/body/div[2]/div/table[4]/tbody/tr/td[5]");
